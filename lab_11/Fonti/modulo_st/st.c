...
static void MMout_of_memory(long size);
static char *MMalloc(long size);
static char *MMrealloc(char *obj, long size);
static void MMfree(char *obj);
static void (*MMoutOfMemory)(long) = MMout_of_memory;
...
/**Function********************************************************************
  Synopsis    [Allocation utility routine.]
  Description [Allocation utility routine.]
  SideEffects []
  SeeAlso     []
******************************************************************************/
